...
def _selector_top_k_from_config(draft_config: dict) -> int:
    """Candidate count for DFlash2 path selection.

    Checkpoint default is dflash_config.selector_top_k (16). Override with
    DFLASH_SELECTOR_TOP_K for A/B only. selector_rank is a trained codebook
    width and must stay at the checkpoint value.
    """
        ...
        *,
        ...
        with set_model_tag("dflash2_candidate_selector"):
            self.candidate_selector = CandidateSelector(
                ...
                top_k=_selector_top_k_from_config(draft_config),
                params_dtype=vllm_config.model_config.dtype,

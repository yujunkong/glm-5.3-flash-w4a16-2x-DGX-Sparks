...
class GateLinear(ReplicatedLinear):
    ...
    def __init__(
        ...
        # Stock 487ecf187 gated this on Hopper/Blackwell specialized kernels,
        # so GB10 (family-120) fell through to F.linear+cast. Allow cuBLAS on
        # any CUDA/ROCm device with no bias (vLLM #54048 / #49921).
